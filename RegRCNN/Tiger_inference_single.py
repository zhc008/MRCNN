...
if __name__=="__main__":
    ...
    list_folder = ["/cis/home/zchen163/my_documents/XTC_data/manual_sparse_small/"]
                ...
                for x in range(1):
                      ...
                      for y in range(1):
                           ...
                           for z in range(1):
                            ...
                            #    segmentation[:, x:x+quad_size-stride, y:y+quad_size-stride] = np.maximum(
                            #        cleaned_seg[:, :quad_size-stride, :quad_size-stride], 
                            #        segmentation[:, x:x+quad_size-stride, y:y+quad_size-stride])
