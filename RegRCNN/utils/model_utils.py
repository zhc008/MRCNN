...
def refine_proposals(rpn_pred_probs, rpn_pred_deltas, proposal_count, batch_anchors, cf):
    ...
    for ix in range(batch_scores.shape[0]):
        ...
        boxes_before_nms = boxes.cpu().detach().numpy()
        # np.save("/cis/home/zchen163/my_documents/XTC_data/check_features/nms02_50_96_96_32/boxes_before_nms.npy", boxes_before_nms)
        # np.save("/cis/home/zchen163/my_documents/XTC_data/check_features/nms02_50_96_96_32_fliped_1000epoch/boxes_before_nms.npy", boxes_before_nms)
        # np.save("/cis/home/zchen163/my_documents/XTC_data/check_features/nms02_50_96_96_32_blacken_600epoch/boxes_before_nms.npy", boxes_before_nms)
        # np.save("/cis/home/zchen163/my_documents/XTC_data/check_features/nms02_50_96_96_32_shifted_600epoch/boxes_before_nms.npy", boxes_before_nms)
        # np.save("/cis/home/zchen163/my_documents/XTC_data/check_features/nms02_50_96_96_32_shifted4_600epoch/boxes_before_nms.npy", boxes_before_nms) #Gaby commented it out
