...
def parallel_sparse(chunk, width=1024,height=1024,depth_im=303, chunk_size=76):
    ...
    for i in patches:
        try:
            file = open(f"/cis/home/gcoste1/MaskReg/MaskRegInference/PatchesStorageParallel4/p{i}.pkl", 'rb') #GABY CHanged
...
if __name__=="__main__":
    ...
    sparse_buffer_dir ="/cis/home/gcoste1/MaskReg/MaskRegInference/PatchesStorageParallel4/" #GABY CHANGED for access PATCH STORAGE
    ...
    list_folder = ["/cis/home/gcoste1/MaskReg/FosTrapSep2024/F09_2"] #GABY Folders to run here
