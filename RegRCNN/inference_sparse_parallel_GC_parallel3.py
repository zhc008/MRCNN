...
def parallel_sparse(chunk, width=1024,height=1024,depth_im=303, chunk_size=76):
    ...
    for i in patches:
        try:
            file = open(f"/cis/home/gcoste1/MaskReg/MaskRegInference/PatchesStorageParallel3/p{i}.pkl", 'rb') #GABY CHanged
...
if __name__=="__main__":
    ...
    sparse_buffer_dir ="/cis/home/gcoste1/MaskReg/MaskRegInference/PatchesStorageParallel3/" #GABY CHANGED for access PATCH STORAGE
    ...
    list_folder = ["/cis/home/gcoste1/MaskReg/FosTrapSep2024/F09_1/last"] #GABY Folders to run here
